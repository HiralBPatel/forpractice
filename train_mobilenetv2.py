...
Trains MobileNetV2 model with two-phase approach (frozen base -> fine-tuning)
"""
...
def main():
    """
    Main training function for MobileNetV2 model.
    """
    # ============================================================================
    # 1. CONFIGURATION
    # ============================================================================
    ...
    # ============================================================================
    print("\n" + "-"*70)
    print("Applying MobileNetV2-specific preprocessing...")
    print("-"*70)
